...
patchFile('portfolio/website-optimization/index.html', (html) => {
  let mod = html.replace(
    /<span class="cs-num">01 — CONTEXT<\/span>\s*<h2>What is the project\?<\/h2>/,
  ...
  mod = mod.replace(
    ...
    `<span class="cs-num">06 — REAL WORK / PROOF</span>
          ...
          <p>Real platform data demonstrating the technical optimization and organic growth of my personal portfolio website.</p>
          <div style="margin:2rem 0;">
            <div style="background:#111; padding: 1rem; border:1px solid rgba(255,255,255,0.08); border-radius:8px; margin-bottom: 2rem;">
              <img src="../../assets/proof/personal-pagespeed-insights.png" alt="PageSpeed Insights Mobile Performance" style="width:100%; border-radius:4px; margin-bottom:1rem;">
              <p style="font-size:0.9rem; color:var(--text-secondary); text-align:center;">PageSpeed Insights — Achieving 90+ mobile performance scores via Core Web Vitals optimization.</p>
            </div>
            <div style="background:#111; padding: 1rem; border:1px solid rgba(255,255,255,0.08); border-radius:8px;">
              <img src="../../assets/proof/personal-ga4-dashboard.png" alt="Google Analytics 4 Traffic Growth" style="width:100%; border-radius:4px; margin-bottom:1rem;">
              <p style="font-size:0.9rem; color:var(--text-secondary); text-align:center;">GA4 Analytics — Real-time event tracking and active user acquisition over time.</p>
            </div>
          </div>
        </article>
...
patchFile('portfolio/index.html', (html) => {
  return html.replace(
    '<h3><a href="website-optimization/">Website SEO &amp; Speed</a></h3>',
    '<h3><a href="website-optimization/">Personal Website SEO &amp; Speed</a></h3>'
  );
});
